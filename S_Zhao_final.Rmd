...
This document is for the final project of the LSE **ME415** Summer Methods Programme course. It contains the R code that I used for this project, as well as a step-by-step analysis of the output.
